...
<div class="row">
	<div class="col-md-8 col-md-offset-2">
		...
		@if ($crud->hasAccess('list'))
			<a href="{{ url($crud->route) . "?" . http_build_query($crud->request->query()) }}" class="hidden-print"><i class="fa fa-angle-double-left"></i> {{ trans('backpack::crud.back_to_all') }} <span>{{ $crud->entity_name_plural }}</span></a><br><br>
		@endif
